...
<head>
    ...
    <meta name="author" content="José max eichenberger">
...
<body>
    @include('components.svg.dropdownTemaSVG')
    @include('components.dropdown.dropdownTema')

    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">SOS Programador</a>

        <ul class="navbar-nav flex-row d-md-none">
            <li class="nav-item text-nowrap">
                @include('components.button.navbarSearchBtn')
            </li>
            <li class="nav-item text-nowrap">
                @include('components.button.sidebarMenuBtn')
            </li>
        </ul>
