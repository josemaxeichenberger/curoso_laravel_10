...
<form class="row g-3" method="POST" action="{{route('produto.store')}}">
    @csrf
    <div class="col-md-4">
    ...
    <div class="col-md-4">
      ...
      @enderror" id="valor"value="{{old('valor')}}"   data-mask="#.##0,00" data-mask-reverse="true" data-mask-maxlength="false" >
      @if ($errors->has('valor'))
      <div class="invalid-feedback">
        {{$errors->first('valor')}}
      </div>
